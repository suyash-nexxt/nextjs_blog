        ...
        <div className='lg:flex flex-wrap'>
          ...
          >
            <div className={`${styles.overlay} bg-gray-900 dark:bg-gray-800`}>
              <p
                className={`text-gray-100 tracking-widest leading-loose m-2 lg:m-6`}
              >
                Real time chat app where users can create their own channel or
                join existing ones. Built with ReactJS for frontend and Firebase
                for user authentication and real time database.
              </p>
              <a
          ...
          >
            <div className={`${styles.overlay} bg-gray-900 dark:bg-gray-800`}>
              <p className={`text-gray-100 tracking-widest leading-loose m-6`}>
          ...
          <div
            className={`h-60 mb-4 lg:mb-0 lg:border-t-2 lg:border-r-2 lg:min-w-1/2 lg:h-96 bg-gray-800 bg-gray-800 bg-project-fpl bg-contain md:bg-cover lg:bg-contain relative ${styles.container}`}
          >
            <div className={`${styles.overlay} bg-gray-900 dark:bg-gray-800`}>
              <p
                className={`text-gray-100 tracking-widest leading-loose m-2 lg:m-6`}
